...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.getDirection = function(lat, lng, name) {
        ...
        // titik hasil "Search Location" jadi origin bila ada
    ...
    function fitMapToBounds() {
        const layers = [mainAirportMarker, nearbyMarkersGroup, radiusCircle];
    ...
    document.addEventListener('click', e => {
        if (e.target.id === 'resetFilter') {
            ...
            const gmClear = document.getElementById('gmClearBtn');
